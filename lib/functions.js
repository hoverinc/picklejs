...
export const nElments = (number, el, parent, text) => {
    getNormalized([parent, el], { singular: true, text })
        .should('have.length', number);
};

export const textOnEl = (text, el, parent) => shouldExist(el, { parent, text });

export const elExists = (el, parent, text) => shouldExist(el, { parent }, text);
